...
// Thu Jul  3 15:58:07 2014 by ROOT version 5.32/00
// from TTree LHEF/Analysis tree
// found on file: LNuAA_SM.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("LNuAA_SM.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("LNuAA_SM.root");
      }
